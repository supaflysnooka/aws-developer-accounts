...
try {
    ...
    # Save to temp files
    $BudgetFile = [System.IO.Path]::Combine([System.IO.Path]::GetTempPath(), "budget-$DeveloperName.json")
    $NotificationsFile = [System.IO.Path]::Combine([System.IO.Path]::GetTempPath(), "notifications-$DeveloperName.json")
